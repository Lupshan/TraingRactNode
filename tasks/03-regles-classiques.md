...
- [ ] Trancher le comportement des bords de la grille : torique (les bords se rebouclent) ou bords morts (les cellules hors grille sont considérées mortes) — décision notée comme ouverte dans `CLAUDE.md`
