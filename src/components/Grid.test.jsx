...
describe('Grid', () => {
  ...
  it('renders a canvas sized to the grid dimensions and cell size', () => {
    const grid = [
      [false, false],
      [false, false],
    ]
    render(<Grid grid={grid} onCellClick={() => {}} cellSize={10} />)
  ...
  it('calls onCellClick with the row/col matching the click position', () => {
    ...
    render(<Grid grid={grid} onCellClick={onCellClick} cellSize={10} />)
